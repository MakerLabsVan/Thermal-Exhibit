 ...
 * Description: To display how different materials react under heating. 
                The push button Turns on a heating bulb and heats materials.
                Bulb shuts off if any of the detected temperature readings are 
                greater than 40 degress C until 40 degrees celsius or until on 30
 *              Thermistors are used to detect temperature and seven segment
